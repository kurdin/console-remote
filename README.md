...
Send log, debug or test information from any webpage, web application or node.js server to remote logger. View output results on any device: tablet, phone or on desktop in a separate, full screen, browser window at http://console.re/project-channel-name
